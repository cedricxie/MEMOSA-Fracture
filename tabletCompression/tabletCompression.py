...
beamFront = 3
IDs = (2, 3,5,6,7,8)
BoundaryPositionTop = 4.9999e-3-1e-5 #Top
BoundaryPositionRight = 1e-5 #Right
BoundaryPositionLeft = -1e-5
BoundaryPositionBottom = -4.9999e-3+1e-5
...
cFED = 400                    # critical fracture energy density, J/m^2
...
MidOInterval_l = 50
OPFLimit = 0.02
OUpLimit=60                   #Upper Limit for large displacement step
