...
beamRight = 5
IDs = (2, 4, 5, 6)
BoundaryPositionTop=15e-6-15e-6/200 #Top
BoundaryPositionRight=15e-6-15e-6/200 #Right
BoundaryPositionBottom=15e-6/200 #Bottom
BoundaryPositionLeft=15e-6/200 #Left
...
fiber_file_name = "fiber-0.55"+".txt"  
...
################Forcing perfect region################  
        ...
        for fiber_count in range(0,NumofFiber) :
            ...
            (coordA[i,1]-fiber_y[fiber_count])**2)<fiber_r[fiber_count]**2:
                ...
                K_local[i]=Lamda_local[i]+G_local[i]
