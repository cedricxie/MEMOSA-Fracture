...
def dumpvtkEntireFractureDomain(geomFields, nmesh, meshesLocal, meshesGlobal, mtype, tFields,file_name, title_name,nstep):
  #cell sites
  cellSites = []
  ...
  if MPI.COMM_WORLD.Get_rank() == 0:
     ...
     writer_fracture = exporters.VTKWriterA(geomFields,meshesGlobal,"fracture-equil-"+str(nstep)+".vtk","fracture output",False,0)
     writer_fracture.init()
     writer_fracture.writeScalarField(tFieldGlobal,"PhaseField")
