...
PF_VB = (8,)
PF_FB = (2, 3, 4, 6, 7, 9)
BoundaryPositionTop=8.94e-6 #Top
BoundaryPositionRight=8.94e-6 #Right
BoundaryPositionBottom=6.0e-8 #Bottom
BoundaryPositionLeft=6.0e-8 #Left
...
numStructIterations = 2       # Number of iterations for structure model, automatically set to 1 when StructIterFlag == 0
numPFIterations = 2           # Number of iterations for fracture model
...
StructTolerance = 1e-1         #Tolerance for structure model inner iteration
StructOuterTolerance = 1e-1
StructIterFlag = 1             #1--Do structure model iteration; 0--No structure model iteration
StructIterUpLimit = 50

PFTolerance = 1e-1             #Tolerance for fracture model iteration
PFOuterTolerance = 1e-1
...
structure_file_name = "vtkresult_structure-pmma-fiber" + ".dat"
inter_status_file_name = "vtkresult_inter-pmma-fiber" + ".dat"
equil_status_file_name = "vtkresult_equil-pmma-fiber" + ".dat"
fracture_file_name = "vtkresult_fracture-pmma-fiber" + ".dat" 
...
##########################################################################################
   ...
   if nstep % OInterval ==0:
       vtkEntireStructureDomainPara.dumpvtkEntireStructureDomain(nmesh,  meshes, fluent_meshes, options.type, structureFields,structure_file_name,title_name,Total_count) 
   #Output Fracture Module 
   if nstep % OInterval ==0:
       vtkEntireFractureDomainPara.dumpvtkEntireFractureDomain(geomFields, nmesh,  meshes, fluent_meshes, options.type, fractureFields,fracture_file_name,title_name,nstep)
