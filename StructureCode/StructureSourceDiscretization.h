...
public:
                       ...
                       const bool isBoundary, const bool isSymmetry)
  {
	...
	const VectorT3& Af = faceArea[f];
        ...
        if ((2.0*faceMuOld+faceLambdaOld)*faceEigenvalue[0]+faceLambdaOld*faceEigenvalue[1]+faceLambdaOld*faceEigenvalue[2] >0 && pfperfectCell[c0]!=-1 && pfperfectCell[c1]!=-1){
        ...
        if (faceLambdaOld*faceEigenvalue[0]+(2.0*faceMuOld+faceLambdaOld)*faceEigenvalue[1]+faceLambdaOld*faceEigenvalue[2] >0 && pfperfectCell[c0]!=-1 && pfperfectCell[c1]!=-1){
        ...
        if (faceLambdaOld*faceEigenvalue[0]+faceLambdaOld*faceEigenvalue[1]+(2.0*faceMuOld+faceLambdaOld)*faceEigenvalue[2] >0 && pfperfectCell[c0]!=-1 && pfperfectCell[c1]!=-1){
