...
#ifndef _STRUCTUREPLASTICDISCRETIZATION_H_
#define _STRUCTUREPLASTICDISCRETIZATION_H_
...
class StructurePlasticDiscretization : public Discretization
{
public:
  ...
  StructurePlasticDiscretization(const MeshList& meshes,
